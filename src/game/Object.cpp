...
bool WorldObject::IsInBetween(const WorldObject *obj1, const WorldObject *obj2, float size) const
{
    ...
    float dObj1 = GetExactDist2d(obj1->GetPositionX(), obj1->GetPositionY());
    return abs(sin(angle)) * dObj1 < size
        && cosAngle > 0
        && cosAngle * dObj1 < obj1->GetExactDist2d(obj2->GetPositionX(), obj2->GetPositionY());
}
